...
ALTER TABLE Compensations DISABLE CONSTRAINT fk_EMP;
...
SET DEFINE OFF;
Insert into Compensations (EMPLOYEE_ID ) values (107);
Insert into Compensations (EMPLOYEE_ID ) values (106);
Insert into Compensations (EMPLOYEE_ID ) values (101);
Insert into Compensations (EMPLOYEE_ID ) values (1);
Insert into Compensations (EMPLOYEE_ID ) values (3);
Insert into Compensations (EMPLOYEE_ID ) values (2);
Insert into Compensations (EMPLOYEE_ID ) values (11);
Insert into Compensations (EMPLOYEE_ID ) values (10);
Insert into Compensations (EMPLOYEE_ID ) values (14);
Insert into Compensations (EMPLOYEE_ID ) values (12);
Insert into Compensations (EMPLOYEE_ID ) values (13);
Insert into Compensations (EMPLOYEE_ID ) values (9);
Insert into Compensations (EMPLOYEE_ID ) values (104);
Insert into Compensations (EMPLOYEE_ID ) values (4);
Insert into Compensations (EMPLOYEE_ID ) values (5);
Insert into Compensations (EMPLOYEE_ID ) values (8);
Insert into Compensations (EMPLOYEE_ID ) values (7);
Insert into Compensations (EMPLOYEE_ID ) values (6);
Insert into Compensations (EMPLOYEE_ID ) values (102);
Insert into Compensations (EMPLOYEE_ID ) values (103);
Insert into Compensations (EMPLOYEE_ID ) values (105);
Insert into Compensations (EMPLOYEE_ID ) values (17);
Insert into Compensations (EMPLOYEE_ID ) values (16);
Insert into Compensations (EMPLOYEE_ID ) values (18);
Insert into Compensations (EMPLOYEE_ID ) values (19);
Insert into Compensations (EMPLOYEE_ID ) values (20);
Insert into Compensations (EMPLOYEE_ID ) values (15);
Insert into Compensations (EMPLOYEE_ID ) values (49);
Insert into Compensations (EMPLOYEE_ID ) values (48);
Insert into Compensations (EMPLOYEE_ID ) values (47);
Insert into Compensations (EMPLOYEE_ID ) values (46);
Insert into Compensations (EMPLOYEE_ID ) values (50);
Insert into Compensations (EMPLOYEE_ID ) values (56);
Insert into Compensations (EMPLOYEE_ID ) values (57);
Insert into Compensations (EMPLOYEE_ID ) values (58);
Insert into Compensations (EMPLOYEE_ID ) values (59);
Insert into Compensations (EMPLOYEE_ID ) values (60);
Insert into Compensations (EMPLOYEE_ID ) values (61);
Insert into Compensations (EMPLOYEE_ID ) values (62);
Insert into Compensations (EMPLOYEE_ID ) values (80);
Insert into Compensations (EMPLOYEE_ID ) values (64);
Insert into Compensations (EMPLOYEE_ID ) values (65);
Insert into Compensations (EMPLOYEE_ID ) values (66);
Insert into Compensations (EMPLOYEE_ID ) values (67);
Insert into Compensations (EMPLOYEE_ID ) values (68);
Insert into Compensations (EMPLOYEE_ID ) values (69);
Insert into Compensations (EMPLOYEE_ID ) values (70);
Insert into Compensations (EMPLOYEE_ID ) values (71);
Insert into Compensations (EMPLOYEE_ID ) values (72);
Insert into Compensations (EMPLOYEE_ID ) values (73);
Insert into Compensations (EMPLOYEE_ID ) values (74);
Insert into Compensations (EMPLOYEE_ID ) values (75);
Insert into Compensations (EMPLOYEE_ID ) values (76);
Insert into Compensations (EMPLOYEE_ID ) values (77);
Insert into Compensations (EMPLOYEE_ID ) values (78);
Insert into Compensations (EMPLOYEE_ID ) values (79);
Insert into Compensations (EMPLOYEE_ID ) values (55);
Insert into Compensations (EMPLOYEE_ID ) values (54);
Insert into Compensations (EMPLOYEE_ID ) values (53);
Insert into Compensations (EMPLOYEE_ID ) values (52);
Insert into Compensations (EMPLOYEE_ID ) values (51);
Insert into Compensations (EMPLOYEE_ID ) values (63);
Insert into Compensations (EMPLOYEE_ID ) values (85);
Insert into Compensations (EMPLOYEE_ID ) values (86);
Insert into Compensations (EMPLOYEE_ID ) values (87);
Insert into Compensations (EMPLOYEE_ID ) values (88);
Insert into Compensations (EMPLOYEE_ID ) values (89);
Insert into Compensations (EMPLOYEE_ID ) values (90);
Insert into Compensations (EMPLOYEE_ID ) values (91);
Insert into Compensations (EMPLOYEE_ID ) values (92);
Insert into Compensations (EMPLOYEE_ID ) values (93);
Insert into Compensations (EMPLOYEE_ID ) values (94);
Insert into Compensations (EMPLOYEE_ID ) values (95);
Insert into Compensations (EMPLOYEE_ID ) values (96);
Insert into Compensations (EMPLOYEE_ID ) values (97);
Insert into Compensations (EMPLOYEE_ID ) values (98);
Insert into Compensations (EMPLOYEE_ID ) values (99);
Insert into Compensations (EMPLOYEE_ID ) values (100);
Insert into Compensations (EMPLOYEE_ID ) values (81);
Insert into Compensations (EMPLOYEE_ID ) values (82);
Insert into Compensations (EMPLOYEE_ID ) values (83);
Insert into Compensations (EMPLOYEE_ID ) values (84);
Insert into Compensations (EMPLOYEE_ID ) values (33);
Insert into Compensations (EMPLOYEE_ID ) values (44);
Insert into Compensations (EMPLOYEE_ID ) values (43);
Insert into Compensations (EMPLOYEE_ID ) values (42);
Insert into Compensations (EMPLOYEE_ID ) values (41);
Insert into Compensations (EMPLOYEE_ID ) values (26);
Insert into Compensations (EMPLOYEE_ID ) values (27);
Insert into Compensations (EMPLOYEE_ID ) values (28);
Insert into Compensations (EMPLOYEE_ID ) values (29);
Insert into Compensations (EMPLOYEE_ID ) values (30);
Insert into Compensations (EMPLOYEE_ID ) values (31);
Insert into Compensations (EMPLOYEE_ID ) values (32);
Insert into Compensations (EMPLOYEE_ID ) values (45);
Insert into Compensations (EMPLOYEE_ID ) values (34);
Insert into Compensations (EMPLOYEE_ID ) values (35);
Insert into Compensations (EMPLOYEE_ID ) values (36);
Insert into Compensations (EMPLOYEE_ID ) values (37);
Insert into Compensations (EMPLOYEE_ID ) values (38);
Insert into Compensations (EMPLOYEE_ID ) values (39);
Insert into Compensations (EMPLOYEE_ID ) values (40);
Insert into Compensations (EMPLOYEE_ID ) values (25);
Insert into Compensations (EMPLOYEE_ID ) values (24);
Insert into Compensations (EMPLOYEE_ID ) values (23);
Insert into Compensations (EMPLOYEE_ID ) values (22);
Insert into Compensations (EMPLOYEE_ID ) values (21);
...
ALTER TABLE Compensations ENABLE CONSTRAINT fk_EMP;
